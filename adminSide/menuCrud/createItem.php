...
<form method="POST" action="success_create.php" class="ht-600 w-50">
        ...
        <div class="form-group"> 
            ...
            <input type="text" name="item_name" id="item_name" placeholder="Kachhi Biriyani" required class="form-control <?php echo (!empty($itemname_err)) ? 'is-invalid' : ''; ?>" ><br>
        ...
        <div class="form-group">
            ...
            <input min='0.01' type="number" name="item_price" id="item_price" placeholder="500 Tk" step="0.01" required class="form-control <?php echo (!empty($itemprice_err)) ? 'is-invalid' : ''; ?>" ><br>
            <span class="invalid-feedback"></span>
        </div>
