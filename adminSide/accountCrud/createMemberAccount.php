    ...
    <form method="POST" action="success_create_member_account.php" class="ht-600 w-50">
        <div class="form-group">
            ...
            <input type="text" name="email" class="form-control <?php echo !$email_Err ?:
                'is-invalid'; ?>" id="email" required email="email" placeholder="arwas@devine.bar.com" value="<?php echo $email; ?>"><br>
        ...
        <div class="form-group">
            ...
            <input placeholder="+880 985 3921" type="text" name="phone_number" id="phone_number" required class="form-control <?php echo $phone_number_err ? 'is-invalid' : ''; ?>" value="<?php echo $phone_number; ?>"><br>
            <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input placeholder="PaSSw@rd" type="password" name="password" id="password" required class="form-control <?php echo $password_err ? 'is-invalid' : ''; ?>"><br>
            <div class="invalid-feedback">
