...
<div class="wrapper">
    ...
    <form method="POST" action="success_createMembership.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="member_name" placeholder="Ariful Islam" class="form-control <?php echo $member_name_err ? 'is-invalid' : ''; ?>" id="member_name" required value="<?php echo $member_name; ?>"><br>
            <div class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" placeholder="arwas@devine.bar.com" class="form-control <?php echo !$emailErr ?: 'is-invalid'; ?>" id="email" required value="<?php echo $email; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone_number" placeholder="+880101231234" class="form-control <?php echo !$phone_numberErr ?: 'is-invalid'; ?>" id="phone_number" required value="<?php echo $phone_number; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="password" name="password" placeholder="arwas1234@" id="password" required class="form-control <?php echo !$password_err ?: 'is-invalid' ; ?>" value="<?php echo $password; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
