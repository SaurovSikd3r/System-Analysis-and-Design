...
<div class="wrapper">
    ...
    <form method="POST" action="succ_create_staff.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="staff_name" placeholder="Ariful Anik" id="staff_name" required class="form-control <?php echo (!empty($staff_name_err)) ? 'is-invalid' : ''; ?>"><br>
        ...
        <div class="form-group">
            ...
            <input type="text" name="email" placeholder="arwasdevine@bar.com" class="form-control <?php echo !$emailErr ?: 'is-invalid'; ?>" id="email" required value="<?php echo $email; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
        ...
        <div class="form-group">
            ...
            <input type="password" name="password" placeholder="anik321@" id="password" required class="form-control <?php echo !$password_err ?: 'is-invalid' ; ?>" value="<?php echo $password; ?>"><br>
            <div id="validationServerFeedback" class="invalid-feedback">
